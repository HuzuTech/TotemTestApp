...
(function() {
  ...
  Compositor = (function() {
    ...
    Compositor.prototype.sequence = function(tasks) {
      ...
      if (!(seq = typeof tasks[0] === "function" ? tasks[0]() : void 0)) {
...
(function() {
  ...
  Totem = (function() {
    ...
    Totem.prototype.avatars = function(representation) {
      var avatars, categories, inventory,
        _this = this;
      if (representation == null) {
        representation = this._representation;
      }
    ...
    Totem.prototype.setDrawing = function(avatar, canvas, autoDraw) {
      if (!this.canvasIsDrawing(avatar, canvas)) {
    ...
    Totem.prototype.stopDrawing = function(canvas) {
    ...
    Totem.prototype.canvasIsDrawing = function(avatar, canvas) {
...
},{"./HAPIRest":12}],16:[function(require,module,exports){
// Generated by CoffeeScript 1.6.1
(function() {
  var HAPIErrorParser;
